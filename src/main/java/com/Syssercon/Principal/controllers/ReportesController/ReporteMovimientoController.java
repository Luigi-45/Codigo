...
import com.Syssercon.Principal.BO.ReporteBO.IReporteMovimientoBO;
...
@RestController
@RequestMapping("/report/movimiento")
@CrossOrigin(origins = "*")
public class ReporteMovimientoController {
    
    @Autowired
	private IReporteMovimientoBO reporteMovimientoBO;

	@GetMapping(path = "/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws  Exception {
		Reporte ent = reporteMovimientoBO.obtenerReporte(params);
