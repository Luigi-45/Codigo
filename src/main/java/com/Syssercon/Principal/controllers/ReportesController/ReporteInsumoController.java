...
import com.Syssercon.Principal.BO.ReporteBO.IReporteInsumoBO;

@RestController
@RequestMapping("/report/insumo")
@CrossOrigin(origins = "*")
public class ReporteInsumoController {

	@Autowired
	private IReporteInsumoBO reporteInsumoBO;

	@GetMapping(path = "/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws  Exception {
		Reporte ent = reporteInsumoBO.obtenerReporteInsumo(params);
	...
	public ResponseEntity<Resource> downloadTipo(@RequestParam Map<String, Object> params)
			throws  Exception {
		Reporte ent = reporteInsumoBO.obtenerReporteInsumoTipo(params);
        ...
        @GetMapping(path = "/downloadUnidad")
	public ResponseEntity<Resource> downloadUnidad(@RequestParam Map<String, Object> params)
			throws  Exception {
		Reporte ent = reporteInsumoBO.obtenerReporteInsumoUnidad(params);
